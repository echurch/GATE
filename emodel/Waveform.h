...
class gate::Waveform : public gate::BObject {
 ...
 private:
  ...
  std::vector< std::pair<unsigned int, float> > _data;
...
inline const std::vector< std::pair<unsigned int,float> >& 
